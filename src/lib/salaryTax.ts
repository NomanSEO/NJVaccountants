...
export const SALARY_TAX_SLABS_2026_27: TaxSlab[] = [
  ...
  { over: 600_000,   upTo: 1_200_000,  baseTax: 0,         rate: 0.01, label: 'Rs. 600,001 – 1,200,000' },
  { over: 1_200_000, upTo: 2_200_000,  baseTax: 6_000,     rate: 0.11, label: 'Rs. 1,200,001 – 2,200,000' },
  { over: 2_200_000, upTo: 3_200_000,  baseTax: 116_000,   rate: 0.20, label: 'Rs. 2,200,001 – 3,200,000' },
  { over: 3_200_000, upTo: 4_100_000,  baseTax: 316_000,   rate: 0.25, label: 'Rs. 3,200,001 – 4,100,000' },
  { over: 4_100_000, upTo: 5_600_000,  baseTax: 541_000,   rate: 0.29, label: 'Rs. 4,100,001 – 5,600,000' },
  { over: 5_600_000, upTo: 7_000_000,  baseTax: 976_000,   rate: 0.32, label: 'Rs. 5,600,001 – 7,000,000' },
  { over: 7_000_000, upTo: Infinity,   baseTax: 1_424_000, rate: 0.35, label: 'Above Rs. 7,000,000' },
]

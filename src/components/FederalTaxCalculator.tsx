    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
      ...
      >
        <h2
          ...
          className="font-display text-[1.5rem] font-bold text-navy"
        >
          Your tax details
        </h2>
        ...
        <div className="mt-7 space-y-5">
          <label className="block">
            <span className="block text-xs font-semibold tracking-[0.08em] uppercase text-slate mb-2">
              Filing status
            </span>
            <select
              ...
              className="w-full bg-cream border border-border rounded-sm px-4 py-3 text-navy outline-none focus:border-gold focus:ring-2 focus:ring-gold/20"
            >
          ...
          <fieldset>
            <legend className="text-xs font-semibold tracking-[0.08em] uppercase text-slate mb-2">
              Deduction method
            </legend>
      ...
      >
        ...
        <div className="relative">
          <div className="flex items-center gap-3 text-xs font-semibold tracking-[0.12em] uppercase text-gold mb-4">
            <span className="block w-[3px] h-[18px] bg-gold" />
            2026 estimate
          </div>
          <h2
          ...
          <div className="mt-6 border border-gold/40 bg-white/5 p-4">
            <div className="text-[0.7rem] tracking-[0.08em] uppercase text-white/50">
              {input.withholding +
              ...
              <table className="w-full min-w-[440px] text-left text-sm">
                ...
                <tbody>
                  {result.bracketBreakdown.length ? (
                    result.bracketBreakdown.map((bracket) => (
                      <tr key={bracket.rate} className="border-t border-border">
                    ...
                    <tr>
                      <td colSpan={3} className="px-4 py-5 text-slate">
    ...
    <label className="block">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full bg-cream border rounded-sm py-3 text-navy outline-none focus:ring-2 focus:ring-gold/20 ${error ? "border-gold focus:border-gold" : "border-border focus:border-gold"} ${prefix ? "pl-8 pr-4" : suffix ? "pl-4 pr-8" : "px-4"}`}
        />
        {suffix && (
      ...
      {error && (
        <span
          id={errorId}
          className="block mt-2 text-xs text-gold-dark"
          role="alert"
        >
          {error}
        </span>
...
function Result({
  ...
  return (
    <div>
      ...
      <div
        className={`font-display text-[1.6rem] font-bold leading-tight ${accent ? "text-gold" : "text-white"}`}
      >
        {value}
      </div>
    </div>

        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-7">
          {posts.map((post, i) => {
            ...
            return (
              <article
                key={post._id}
                className="border border-border rounded-sm overflow-hidden hover:shadow-[0_12px_40px_rgba(11,31,58,0.08)] hover:-translate-y-0.5 transition-all duration-300 group"
              >
                <a
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3
                      className={`font-display font-bold text-navy leading-[1.3] mb-2.5 group-hover:text-gold transition-colors ${i === 0 ? "text-[1.375rem]" : "text-[1.125rem]"}`}
                    >
                      {post.title}
                    </h3>
                    <p className="text-[0.875rem] text-slate leading-[1.6] mb-4">
                      {post.excerpt}
                    </p>

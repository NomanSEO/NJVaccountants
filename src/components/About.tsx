        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="font-display text-[clamp(2rem,3.5vw,2.75rem)] font-bold text-white leading-tight mb-5">
              Built on <em className="not-italic text-gold">Integrity,</em>{" "}
              Driven by Results
            </h2>
            ...
            <div className="grid grid-cols-2 gap-5">
              {PILLARS.map((p) => (
                <div key={p.title} className="border-l-2 border-gold pl-4">
                  ...
                  <div className="text-[0.8125rem] text-white/50 leading-[1.5]">
                    {p.text}
                  </div>
                </div>
              ))}
            ...
            <div className="flex gap-3 flex-wrap mt-8">
              {[
                ...
                <div
                  key={badge}
                  className="inline-flex items-center gap-1.5 bg-gold/10 border border-gold/25 rounded-sm px-3 py-1.5 text-[0.7rem] font-semibold tracking-[0.08em] uppercase text-gold"
                >
                  {badge}
                </div>
              ))}
          ...
          <div className="bg-white/[0.04] border border-gold/20 rounded-md overflow-hidden">
            <div className="bg-gold/10 px-6 py-4 border-b border-gold/[0.15] flex items-center gap-2">
              ...
              <span className="text-[0.75rem] text-white/40 ml-2 font-body">
            ...
            <div className="p-7">
              <div className="flex justify-between items-end mb-6">
                <div>
                  <div className="text-[0.75rem] text-white/45 tracking-[0.08em] uppercase">
                    Avg. Tax Saved
                  </div>
                ...
                <div className="text-right">
                  ...
                  <div className="text-[0.75rem] text-green-400 font-semibold">
                    ↑ 22% YoY
                  </div>
                </div>
              </div>

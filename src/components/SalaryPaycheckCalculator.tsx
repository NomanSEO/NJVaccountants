  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2">
      <section className="border border-border bg-white p-7 shadow-sm">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          ...
          <label className="text-sm text-slate">
            ...
            <select
              ...
              className="mt-1 w-full border border-border p-3 text-navy"
            >
        ...
        <label className="mt-4 flex gap-2 text-sm text-navy">
          <input
            type="checkbox"
        ...
        <label className="mt-2 flex gap-2 text-sm text-navy">
          <input
            type="checkbox"
      ...
      <section className="bg-navy p-7 text-white">
        ...
        <p className="mt-4 text-xs uppercase text-white/60">
